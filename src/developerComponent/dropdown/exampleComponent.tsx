// Example: Using Dropdown component in your application
...
function MyPage() {
  ...
  const dropdownData = {
    ...
    items: [
      ...
      { label: "Delete", value: "delete", onClick: () => console.log("Delete"), divider: true },
  ...
  return (
    <div className="container mx-auto p-4">
      <Dropdown css={dropdownCSS} data={dropdownData} />
    </div>
  );
}
