...
// Match Score Stack Slider Variant Configuration - Shows adjacent cards
export const matchScoreStackSliderCSS = {
...
export interface MatchScoreStackData {
  status: string;
  statusColor: string;
  league: string;
  matchType: string;
...
export const matchScoreStackSliderData = {
  slides: [
    {
      status: "Match Ended",
    ...
    },
    {
      ...
      team1: {
        name: "Delhi Capitals",
        logo: "https://via.placeholder.com/80/0078D4/FFFFFF?text=DC",
        score: "-",
        overs: ""
      },
      team2: {
        name: "Sunrisers Hyderabad",
        logo: "https://via.placeholder.com/80/FF6600/FFFFFF?text=SRH",
        score: "-",
        overs: ""
      },
      summary: "Match starts in 2 days",
      buttonText: "MATCHCENTRE"
    }
  ] as MatchScoreStackData[]
};

interface MatchScoreStackSliderProps {
  css: typeof matchScoreStackSliderCSS;
  data: typeof matchScoreStackSliderData;
}

export const MatchScoreStackSliderComponent: React.FC<MatchScoreStackSliderProps> = ({ css, data }) => {
  ...
  return (
    <div className="w-full relative max-w-full">
      <Swiper
        ...
        navigation={{
          prevEl: '.swiper-button-prev-match-stack',
          nextEl: '.swiper-button-next-match-stack'
        }}
        onSwiper={(swiper) => {
      ...
      <button 
        className={`${css.prevButton} ${css.navigation} swiper-button-prev-match-stack`}
      ...
      <button 
        className={`${css.nextButton} ${css.navigation} swiper-button-next-match-stack`}
