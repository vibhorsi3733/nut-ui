...
export const simpleDropdownCSS = {
  ...
  item: "text-gray-900 dark:text-gray-100 block px-4 py-2.5 text-sm hover:bg-gray-100 dark:hover:bg-gray-700 w-full text-left transition-colors duration-150 cursor-pointer",
  icon: "mr-2"
};
