...
const NewsCardFooter: React.FC<NewsCardFooterProps> = ({ date, shareUrl, shareTitle }) => {
    ...
    <div className="flex items-center justify-between w-full text-white">
      ...
      <div className="relative">
        ...
        {showShareMenu && (
          <div 
            ref={shareMenuRef}
            className="absolute bottom-full right-0 mb-2 bg-black/90 backdrop-blur-sm rounded-lg p-3 shadow-xl border border-white/10 z-50"
          >
