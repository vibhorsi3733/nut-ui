...
const VariantPage = () => {
  ...
  const variant = genericVariants.find(v => v.id === variantId && v.componentId === componentId);
  ...
  const getDataProps = () => {
    switch (componentId) {
      case 'button':
        return [
          { key: 'label', title: 'label', type: 'string', description: 'Button text content. Required.', hasDetails: false },
          { key: 'onClick', title: 'onClick', type: '() => void | undefined', description: 'Click handler function. Called when button is clicked. Optional.', hasDetails: false },
          { key: 'disabled', title: 'disabled', type: 'boolean | undefined', description: 'Disables the button when true. Optional.', hasDetails: false },
          { key: 'type', title: 'type', type: '"button" | "submit" | "reset" | undefined', description: 'Button type attribute. Defaults to "button". Optional.', hasDetails: false }
        ];
      case 'badge':
        return [
          { key: 'label', title: 'label', type: 'string', description: 'Badge text content. Required.', hasDetails: false },
          { key: 'count', title: 'count', type: 'number | undefined', description: 'Optional count number displayed next to the badge label.', hasDetails: false }
        ];
      case 'alert':
        return [
          { key: 'title', title: 'title', type: 'string | undefined', description: 'Alert title text. Optional.', hasDetails: false },
          { key: 'message', title: 'message', type: 'string', description: 'Alert message text. Required.', hasDetails: false },
          { key: 'showClose', title: 'showClose', type: 'boolean | undefined', description: 'Shows close button when true. Optional.', hasDetails: false },
          { key: 'onClose', title: 'onClose', type: '() => void | undefined', description: 'Close handler function. Called when close button is clicked. Optional.', hasDetails: false },
          { key: 'icon', title: 'icon', type: 'ReactNode | undefined', description: 'Optional icon element to display in the alert.', hasDetails: false }
        ];
      case 'avatar':
        return [
          { key: 'src', title: 'src', type: 'string | undefined', description: 'Image URL for the avatar. Optional - will show initials if not provided.', hasDetails: false },
          { key: 'alt', title: 'alt', type: 'string | undefined', description: 'Alternative text for the image. Optional.', hasDetails: false },
          { key: 'name', title: 'name', type: 'string | undefined', description: 'User name for generating initials fallback. Optional.', hasDetails: false },
          { key: 'avatars', title: 'avatars', type: 'Array<{src?: string, alt?: string, name?: string}> | undefined', description: 'Array of avatar objects for group display. Each avatar can have src, alt, and name. Optional.', hasDetails: true }
        ];
      case 'input':
        return [
          { key: 'label', title: 'label', type: 'string | undefined', description: 'Input label text. Optional.', hasDetails: false },
          { key: 'placeholder', title: 'placeholder', type: 'string | undefined', description: 'Placeholder text shown when input is empty. Optional.', hasDetails: false },
          { key: 'value', title: 'value', type: 'string | undefined', description: 'Input value (controlled component). Optional.', hasDetails: false },
          { key: 'type', title: 'type', type: '"text" | "email" | "password" | "number" | "tel" | "url" | "textarea" | undefined', description: 'Input type. Use "textarea" for multi-line input. Optional, defaults to "text".', hasDetails: false },
          { key: 'rows', title: 'rows', type: 'number | undefined', description: 'Number of rows for textarea. Only used when type is "textarea". Optional, defaults to 4.', hasDetails: false },
          { key: 'helperText', title: 'helperText', type: 'string | undefined', description: 'Helper text displayed below input. Optional.', hasDetails: false },
          { key: 'error', title: 'error', type: 'string | undefined', description: 'Error message displayed below input. Optional.', hasDetails: false },
      ...
      case 'dropdown':
        return [
          { key: 'label', title: 'label', type: 'string', description: 'Dropdown button label text. Required.', hasDetails: false },
          { key: 'items', title: 'items', type: 'Array<{label: string, value: string, icon?: ReactNode, onClick?: () => void, disabled?: boolean, divider?: boolean}>', description: 'Array of dropdown menu items. Each item has label, value, and optional icon, onClick, disabled, and divider properties. Required.', hasDetails: true },
          { key: 'placement', title: 'placement', type: '"left" | "right" | undefined', description: 'Menu placement relative to button. Optional, defaults to "left".', hasDetails: false }
        ];
      case 'modal':
        return [
          { key: 'isOpen', title: 'isOpen', type: 'boolean', description: 'Controls modal visibility. Required.', hasDetails: false },
          { key: 'title', title: 'title', type: 'string | undefined', description: 'Modal title text. Optional.', hasDetails: false },
          { key: 'children', title: 'children', type: 'ReactNode | undefined', description: 'Modal content. Can be any React node. Optional.', hasDetails: false },
          { key: 'footer', title: 'footer', type: 'ReactNode | undefined', description: 'Modal footer content. Can be buttons or other React nodes. Optional.', hasDetails: false },
          { key: 'onClose', title: 'onClose', type: '() => void', description: 'Close handler function. Called when modal should close. Required.', hasDetails: false },
          { key: 'showCloseButton', title: 'showCloseButton', type: 'boolean | undefined', description: 'Shows close button when true. Optional, defaults to true.', hasDetails: false }
        ];
      case 'tabs':
        return [
          { key: 'tabs', title: 'tabs', type: 'Array<{id: string, label: string, content: ReactNode, disabled?: boolean}>', description: 'Array of tab objects. Each tab has id, label, content, and optional disabled. Required.', hasDetails: true },
          { key: 'defaultTab', title: 'defaultTab', type: 'string | undefined', description: 'ID of the default active tab. Optional.', hasDetails: false },
          { key: 'variant', title: 'variant', type: '"default" | "pills" | undefined', description: 'Tab variant style. Optional.', hasDetails: false }
        ];
      case 'breadcrumb':
        return [
          { key: 'items', title: 'items', type: 'Array<{label: string, href?: string, icon?: ReactNode}>', description: 'Array of breadcrumb items. Each item has label, optional href, and optional icon. Required.', hasDetails: true },
          { key: 'separator', title: 'separator', type: '"slash" | "chevron" | "dot" | undefined', description: 'Separator style between items. Optional, defaults to "slash".', hasDetails: false }
        ];
      case 'card':
        return [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white via-gray-50/50 to-white dark:from-gray-950 dark:via-gray-900/50 dark:to-gray-950">
      ...
      {/* Sidebar */}
      <GenericSidebar isOpen={false} onClose={() => {}} />
          ...
          <div>
            ...
            <div className={`relative bg-gradient-to-br from-gray-50 via-gray-50 to-gray-100 dark:from-gray-950 dark:via-gray-950 dark:to-gray-900 rounded-xl border-2 border-gray-200 dark:border-gray-800 shadow-lg font-sans ${
              ...
              {componentId === 'button' ? (
                ...
                <Badge css={previewConfig.css as any} data={previewConfig.data as any} />
              ) : componentId === 'alert' ? (
                <Alert css={previewConfig.css as any} data={previewConfig.data as any} />
              ) : componentId === 'avatar' ? (
                ...
                <Breadcrumb css={previewConfig.css as any} data={previewConfig.data as any} />
              ) : null}
            </div>
          </div>
                        ...
                        <div key={prop.key} className="group/prop relative overflow-hidden rounded-lg border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 hover:border-emerald-500/50 dark:hover:border-emerald-500/50 transition-all duration-200">
                          ...
                          {openAccordions.has(`data-${prop.key}`) && (
                            <div className="px-4 pb-4 border-t border-gray-200/50 dark:border-gray-700/50 bg-gray-50/50 dark:bg-gray-800/30 animate-in slide-in-from-top-2 duration-200">
                              ...
                              {false && prop.key === 'columns' && componentId === 'table' && (
                                <div className="mt-3">
                                  <div className="bg-gray-900 dark:bg-gray-950 rounded-lg border border-gray-800 dark:border-gray-700 overflow-hidden">
                                    <div className="px-3 py-1.5 bg-gray-800 dark:bg-gray-900 border-b border-gray-700 dark:border-gray-800 flex items-center gap-2">
                                      <div className="flex gap-1">
                              ...
                              {false && prop.key === 'rows' && componentId === 'table' && (
                                <div className="mt-3">
                                  <div className="bg-gray-900 dark:bg-gray-950 rounded-lg border border-gray-800 dark:border-gray-700 overflow-hidden">
                                    <div className="px-3 py-1.5 bg-gray-800 dark:bg-gray-900 border-b border-gray-700 dark:border-gray-800 flex items-center gap-2">
                                      <div className="flex gap-1">
                              ...
                              {false && prop.key === 'chips' && componentId === 'chip' && (
                                <div className="mt-3">
                                  <div className="bg-gray-900 dark:bg-gray-950 rounded-lg border border-gray-800 dark:border-gray-700 overflow-hidden">
                                    <div className="px-3 py-1.5 bg-gray-800 dark:bg-gray-900 border-b border-gray-700 dark:border-gray-800 flex items-center gap-2">
                                      <div className="flex gap-1">
